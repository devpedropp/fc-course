...
describe("Order repository test", () => {
  ...
  it("should update an order", async () => {
    const customerToUpdateId = "22";
    const customerId = "123";
    await createCustomer(customerId);
    await createCustomer(customerToUpdateId);
    ...
    order.updateCustomer(customerToUpdateId);
    ...
    expect(orderModel.toJSON()).toEqual(expect.objectContaining({
      id: "123",
  ...
  async function createCustomer(customerId: string): Promise<void> {
